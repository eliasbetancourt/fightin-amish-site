      ...
      <div style={{ width: "100%", maxWidth: 900, margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: isTablet ? "1fr" : "1fr 1fr", gap: isMobile ? 20 : 32 }}>
          {[
            ...
            {
              title: "The brand",
              text: "The Fightin' Amish represents Lancaster County's heritage of hard work, craftsmanship, and community. Our wood-grain kits and Amish horse mascot celebrate the region that built us. This is more than a soccer team. It's a movement.",
              icon: "🏗️",
            },
            {
